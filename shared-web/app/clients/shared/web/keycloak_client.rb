  ...
  module Web
    class KeycloakClient
      ...
      def all_organisations
        ...
        organisations["subGroups"].reject{|org| org.blank?}.map do |organisation|
      ...
      def all_teams
        ...
        teams = []
        organisations["subGroups"].reject{|org| org.blank?}.each do |organisation|
          organisation["subGroups"].reject{|team| team.blank?}.map do |team|
      ...
      def all_team_users
        ...
        team_users = []
        id = 1
        users.reject{|usr| usr.blank?}.each do |user|
          user_groups[user[:id]].reject{|groups| groups.blank?}.each do |group|
