...
RSpec.describe UploadNanomaterialsPdfsInLastThreeMonthsJob, :with_stubbed_antivirus do
  include_examples "Active Storage Upload jobs tests"

  # rubocop:disable RSpec/ExampleLength
  # rubocop:disable RSpec/MultipleExpectations
  it "generates a ZIP containing all the nanomaterial notifications PDFs in the last three months" do
    create(:nanomaterial_notification, name: "Zinc peroxide", submitted_at: 4.months.ago, eu_notified: false)
