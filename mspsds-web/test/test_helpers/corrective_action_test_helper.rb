module CorrectiveActionTestHelper
  def fill_in_corrective_action_details(corrective_action, with_product: true, with_business: true)
    ...
    fill_autocomplete "business-picker", with: corrective_action.business.trading_name if with_business
    fill_autocomplete "product-picker", with: corrective_action.product.name if with_product
