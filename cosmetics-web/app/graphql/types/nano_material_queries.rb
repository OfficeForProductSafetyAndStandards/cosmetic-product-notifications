module Types
  module NanoMaterialQueries
    ...
    included do
      ...
      # Add cursor-based pagination for nano_materials with filtering by created_at and updated_at
      ...
      # Query for retrieving the total number of nano materials available
    ...
    # Method to return nano materials with optional filters for created_at and updated_at, along with pagination support
    ...
    # Method to return the total number of nano materials available
