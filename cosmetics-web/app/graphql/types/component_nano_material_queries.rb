module Types
  module ComponentNanoMaterialQueries
    ...
    included do
      ...
      # Add cursor-based pagination for component_nano_materials with filtering by created_at and updated_at
      ...
      # Query for retrieving the total number of ComponentNanoMaterials available
    ...
    # Method to return ComponentNanoMaterials with optional filters for created_at and updated_at, along with pagination support
    ...
    private
      ...
      def filtered_by_date(field:, date:)
        ComponentNanoMaterial.where("#{field} >= ?", date)
      rescue ArgumentError
