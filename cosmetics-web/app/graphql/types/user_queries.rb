  ...
  module UserQueries
    ...
    included do
      ...
      field :users, UserType.connection_type, null: false, camelize: false, description: <<~DESC do
        Retrieve a paginated list of users with optional filters for created_at and updated_at timestamps.
      ...
      DESC
        ...
        argument :from_id, GraphQL::Types::ID, required: false, camelize: false, description: "Retrieve users starting from a specific ID"
      end
    ...
    def users(created_after: nil, updated_after: nil, first: nil, last: nil, after: nil, before: nil, order_by: nil, from_id: nil)
      max_limit = 100
