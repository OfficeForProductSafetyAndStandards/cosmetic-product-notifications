module Types
  class DeletedNotificationType < Types::BaseObject
    ...
    field :created_at, GraphQL::Types::ISO8601DateTime, null: true, camelize: false
    field :updated_at, GraphQL::Types::ISO8601DateTime, null: true, camelize: false
    ...
    field :cpnp_notification_date, GraphQL::Types::ISO8601DateTime, null: true, camelize: false
    ...
    field :notification_complete_at, GraphQL::Types::ISO8601DateTime, null: true, camelize: false
