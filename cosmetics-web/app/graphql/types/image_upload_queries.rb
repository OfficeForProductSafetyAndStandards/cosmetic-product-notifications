  ...
  module ImageUploadQueries
    ...
    included do
      ...
      DESC
        ...
        argument :from_id, GraphQL::Types::ID, required: false, camelize: false, description: "Retrieve image uploads starting from a specific ID"
      end
    ...
    def image_uploads(created_after: nil, updated_after: nil, first: nil, last: nil, after: nil, before: nil, order_by: nil, from_id: nil)
      max_limit = 100
