module Types
  module ResponsiblePersonQueries
    ...
    included do
      ...
      # Add cursor-based pagination for responsible_persons with filtering by created_at and updated_at
      ...
      # Query for retrieving the total number of responsible persons available
    ...
    # Method to return responsible persons with optional filters for created_at and updated_at, along with pagination support
    ...
    # Method to return the total number of responsible persons available
