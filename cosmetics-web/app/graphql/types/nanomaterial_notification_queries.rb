module Types
  module NanomaterialNotificationQueries
    ...
    included do
      ...
      # Add cursor-based pagination for nanomaterial_notifications with filtering by created_at and updated_at
      ...
      # Query for retrieving the total number of nanomaterial notifications available
    ...
    # Method to return nanomaterial notifications with optional filters for created_at and updated_at, along with pagination support
    ...
    # Method to return the total number of nanomaterial notifications available
