...
private
  ...
  def search_notifications
    query = OpenSearchQuery::Ingredient.new(keyword: @search_form.q, match_type: @search_form.exact_or_any_match)
  ...
  def search_params
    params.fetch(:ingredient_search_form, {}).permit(:q, :exact_or_any_match)
  end
