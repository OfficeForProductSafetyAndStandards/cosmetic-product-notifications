...
Rails.application.routes.draw do
  devise_for :submit_users, path: "",  path_names: { sign_up: "sign-up", sign_in: "sign-in", sign_out: "sign-out" }, controllers: { sessions: "users/sessions", registrations: "users/registrations" }
