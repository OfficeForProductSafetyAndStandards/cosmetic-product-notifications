...
describe NotificationHelper do
  ...
  describe "#nano_materials_with_review_period_end_date" do
    ...
    it "returns formated UKN, name and the end where the review period ends for the associated nanomaterial notifications" do
      nano_material_a = instance_double(NanoMaterial, nanomaterial_notification: notification_a)
      nano_material_b = instance_double(NanoMaterial, nanomaterial_notification: notification_b)
      expect(helper.nano_materials_with_review_period_end_date([nano_material_a, nano_material_b]))
    ...
    it "ignoresnanomaterials without an associated nanomaterial notification" do
      nano_material_a = instance_double(NanoMaterial, nanomaterial_notification: nil)
      nano_material_b = instance_double(NanoMaterial, nanomaterial_notification: notification_b)
      expect(helper.nano_materials_with_review_period_end_date([nano_material_a, nano_material_b]))
