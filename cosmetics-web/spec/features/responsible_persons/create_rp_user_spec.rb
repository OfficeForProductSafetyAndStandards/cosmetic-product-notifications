...
RSpec.describe "Responsible person creation journey", type: :feature do
  context "Given as a new user," do
    ...
    scenario "I should be able to create responsible user as a individual sole trader" do
      create_individual_responsible_person
      expect(page).to have_h1("Your cosmetic products")
    end


    scenario "I should be able to create responsible user as a limited company" do
