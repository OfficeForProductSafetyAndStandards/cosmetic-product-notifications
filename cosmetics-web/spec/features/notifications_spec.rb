...
RSpec.describe "Notifications", type: :feature do
  ...
  scenario "Manual, pre-Brexit, frame formulation, single item, with nanomaterials" do
    ...
    expect_to_be_on_is_item_intended_to_be_rinsed_off_or_left_on_page
    answer_is_item_intended_to_be_rinsed_off_or_left_on_with "Left on"

    expect_to_be_on_how_is_user_exposed_to_nanomaterials_page
    answer_how_user_is_exposed_to_nanomaterials_with "Dermal"

    expect_to_be_on_list_the_nanomaterials_page
    answer_nanomaterial_names_with "Carbon Black"

    expect_to_be_on_what_is_the_purpose_of_nanomaterial_page nanomaterial_name: "Carbon Black"
    answer_what_is_purpose_of_nanomaterial_with "Colourant", nanomaterial_name: "Carbon Black"

    expect_to_be_on_is_nanomaterial_listed_in_ec_regulation_page nanomaterial_name: "Carbon Black"
    answer_is_nanomaterial_listed_in_ec_regulation_with "Yes", nanomaterial_name: "Carbon Black"

    expect_to_be_on_does_nanomaterial_conform_to_restrictions_page nanomaterial_name: "Carbon Black"
    ...
    expect_to_be_on_item_subcategoy_page(category: "skin products")
    answer_item_subcategory_with "Make-up products"

    expect_to_be_on_item_sub_subcategory_page(subcategory: "make-up products")
    ...
    expect_to_be_on_check_your_answers_page(product_name: "SkinSoft carbon black eyeshadow")
  ...
  scenario "Manual, pre-Brexit, frame formulation, multi-item, each with nanomaterials" do
    ...
    expect_to_be_on_is_item_available_in_shades_page(item_name: "SkinSoft nano black hair dye kit colourant")
    answer_is_item_available_in_shades_with "No", item_name: "SkinSoft nano black hair dye kit colourant"

    expect_to_be_on_physical_form_of_item_page(item_name: "SkinSoft nano black hair dye kit colourant")
    ...
    expect_to_be_on_is_item_intended_to_be_rinsed_off_or_left_on_page item_name: "SkinSoft nano black hair dye kit colourant"
    answer_is_item_intended_to_be_rinsed_off_or_left_on_with "Rinsed off", item_name: "SkinSoft nano black hair dye kit colourant"

    expect_to_be_on_how_is_user_exposed_to_nanomaterials_page
    answer_how_user_is_exposed_to_nanomaterials_with "Dermal"

    expect_to_be_on_list_the_nanomaterials_page item_name: "SkinSoft nano black hair dye kit colourant"
    answer_nanomaterial_names_with "Carbon Black"
    ...
    expect_to_be_on_item_subcategoy_page(category: "hair and scalp products", item_name: "SkinSoft nano black hair dye kit colourant")
    answer_item_subcategory_with "Hair colouring products"

    expect_to_be_on_item_sub_subcategory_page(subcategory: "hair colouring products", item_name: "SkinSoft nano black hair dye kit colourant")
    answer_item_sub_subcategory_with "Oxidative hair colour products"

    expect_to_be_on_formulation_method_page item_name: "SkinSoft nano black hair dye kit colourant"
    ...
    expect_to_be_on_is_item_available_in_shades_page(item_name: "SkinSoft nano black hair dye kit fixer")
    answer_is_item_available_in_shades_with "No", item_name: "SkinSoft nano black hair dye kit fixer"

    expect_to_be_on_physical_form_of_item_page(item_name: "SkinSoft nano black hair dye kit fixer")
    ...
    expect_to_be_on_is_item_intended_to_be_rinsed_off_or_left_on_page item_name: "SkinSoft nano black hair dye kit fixer"
    answer_is_item_intended_to_be_rinsed_off_or_left_on_with "Rinsed off", item_name: "SkinSoft nano black hair dye kit fixer"

    expect_to_be_on_how_is_user_exposed_to_nanomaterials_page
    answer_how_user_is_exposed_to_nanomaterials_with "Dermal"

    expect_to_be_on_list_the_nanomaterials_page item_name: "SkinSoft nano black hair dye kit fixer"
    answer_nanomaterial_names_with "Carbon Black"
    ...
    expect_to_be_on_item_subcategoy_page(category: "hair and scalp products", item_name: "SkinSoft nano black hair dye kit fixer")
    answer_item_subcategory_with "Hair colouring products"

    expect_to_be_on_item_sub_subcategory_page(subcategory: "hair colouring products", item_name: "SkinSoft nano black hair dye kit fixer")
    answer_item_sub_subcategory_with "Oxidative hair colour products"

    expect_to_be_on_formulation_method_page item_name: "SkinSoft nano black hair dye kit fixer"
    ...
    expect_to_be_on_check_your_answers_page(product_name: "SkinSoft nano black hair dye kit")
