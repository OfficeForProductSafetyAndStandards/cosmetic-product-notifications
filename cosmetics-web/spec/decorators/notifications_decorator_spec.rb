...
RSpec.describe NotificationsDecorator do
  ...
  let(:expected_csv) do
    <<~CSV
      ...
      Product 1,UKCP-00000111,2021-02-20 13:00:00 +0000,,
      Product 2,UKCP-00000222,2021-02-20 13:00:00 +0000,123456789,
      Product 3,UKCP-00000333,2021-02-20 13:00:00 +0000,123456789,2020-09-22 13:00:00 +0100
    CSV
  end
