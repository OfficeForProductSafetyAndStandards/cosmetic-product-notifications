...
RSpec.describe NotificationBuildController, type: :controller do
  ...
  describe "GET #new" do
    it "redirects to the first step of the manual web form" do
      get(:new, params: { notification_reference_number: notification.reference_number })
      expect(response).to redirect_to(notification_build_path(notification.reference_number, "add_product_name"))
    end
  end

  describe "GET #show" do
    it "assigns the correct notification" do
      get(:show, params: { notification_reference_number: notification.reference_number, id: 'add_product_name' })
    ...
    it "redirects to the check your answers page on finish" do
      get(:show, params: { notification_reference_number: notification.reference_number, id: 'wicked_finish' })
      expect(response).to redirect_to(edit_responsible_person_notification_path(notification.responsible_person, notification))
    end
  end

  describe "POST #update" do
    it "assigns the correct notification" do
      post(:update, params: { notification_reference_number: notification.reference_number, id: 'add_product_name',
    ...
    it "creates a component if single_or_multi_component set to single" do
      post(:update, params: { notification_reference_number: notification.reference_number, id: 'single_or_multi_component',
    ...
    it "redirects to add_import_country step if is_imported set to true" do
      post(:update, params: { notification_reference_number: notification.reference_number, id: 'is_imported',
                              is_imported: "true" })
    ...
    it "adds an error if user submits import_country with a blank value" do
      post(:update, params: { notification_reference_number: notification.reference_number, id: 'add_import_country',
    ...
    it "adds image files to a notification in the add_product_image step" do
      post(:update, params: { notification_reference_number: notification.reference_number, id: 'add_product_image',
                              image_upload: [file] })
